...
import com.jby.vegeapp.Utils.PermissionUtil;
import com.jby.vegeapp.Utils.Util;
import com.jby.vegeapp.adapter.BlueListViewAdapter;
import com.jby.vegeapp.printer.Manager.PopupWindowManager;
...
import static com.jby.vegeapp.Utils.Util.rotate;
...
public class PrintfBlueListActivity extends Activity {
    ...
    private void setLister() {
        ...
        tv_blue_list_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(bluetoothDeviceArrayList.size() > 0) setResult(PROCEED_TO_PRINT);
                onBackPressed();
            }
        });
    ...
    private void initData() {
        ...
        if (printfManager.isConnect()) {
            blueName = SharedPreferenceManager.getBluetoothName(context);
            blueAddress = SharedPreferenceManager.getBluetoothAddress(context);
        }
    ...
    public static void startActivity(Activity activity) {
        ...
        activity.startActivityForResult(intent, PROCEED_TO_PRINT);
    }
