...
public class PickUpHistoryExpandableAdapter extends BaseExpandableListAdapter {
    ...
    private PickUpHistoryExpandableAdapterCallBack pickUpHistoryExpandableAdapterCallBack;

    public PickUpHistoryExpandableAdapter(Context context, ArrayList<HistoryParentObject> historyParentObjectArrayList, PickUpHistoryExpandableAdapterCallBack pickUpHistoryExpandableAdapterCallBack) {
        this.context = context;
        this.historyParentObjectArrayList = historyParentObjectArrayList;
        this.pickUpHistoryExpandableAdapterCallBack = pickUpHistoryExpandableAdapterCallBack;
    }
...
//        viewHolder.edit.setVisibility(isToday(object.getCreated_time()) ? View.VISIBLE : View.GONE);
        ...
        viewHolder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                pickUpHistoryExpandableAdapterCallBack.edit(childPosition);
            }
        });
        return view;
    }
    ...
    private static class ChildViewHolder {
        private TextView farmer, numItem, time, edit;
    ...
    public interface PickUpHistoryExpandableAdapterCallBack {
