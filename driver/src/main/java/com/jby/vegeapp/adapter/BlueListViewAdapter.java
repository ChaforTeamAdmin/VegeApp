...
public class BlueListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_blue_list_address = convertView.findViewById(R.id.tv_blue_list_address);
            holder.tv_blue_list_name = convertView.findViewById(R.id.tv_blue_list_name);
