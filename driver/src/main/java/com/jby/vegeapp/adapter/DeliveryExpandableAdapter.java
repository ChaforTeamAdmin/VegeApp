...
public class DeliveryExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public DeliveryExpandableAdapter(Context context, ArrayList<ProductParentObject> addedProductParentObjectArrayList, ProductExpandableAdapterCallBack productExpandableAdapterCallBack){
...
/*-----------------------------------------------------------------------------PARENT VIEW-------------------------------------------------------------*/
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        groupViewHolder.quantity.setText("x " + addedProductParentObjectArrayList.get(groupPosition).getProductChildObjectArrayList().size());
        return convertView;
    }
...
/*---------------------------------------------------------------------------CHILD VIEW-------------------------------------------------------------------*/
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View view, ViewGroup parent) {
        ...
        viewHolder.arrowRight.setOnClickListener(new View.OnClickListener() {
            @Override
