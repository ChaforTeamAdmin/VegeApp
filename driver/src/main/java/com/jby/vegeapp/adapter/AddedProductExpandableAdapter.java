    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View view, ViewGroup parent) {
        ...
        viewHolder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                productExpandableAdapterCallBack.deleteMessage("Warning", "Are you sure that you want to delete this id ?", childPosition);
            }
        });
        return view;
    }
...
/*-----------------------------------------------------------------------------------END OF CHILD VIEW---------------------------------------------------------*/
    ...
    public interface ProductExpandableAdapterCallBack{
        void deleteMessage(String title, String content, int position);
    }
}
